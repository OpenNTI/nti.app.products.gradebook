...
class TestSimpleGradingPolicy(unittest.TestCase):
	...
	def test_simple_grade_predictor_for_late_assignments(self, mock_ga, mock_gap, mock_get_assignments, mock_is_due):
		...
		cap['tag:nextthought.com,2011-10:due_and_passed'] = {'auto_grade': {'total_points': 5}}
		cap['tag:nextthought.com,2011-10:due_and_failed'] = {'auto_grade': {'total_points': 5}}
		...
		cap['tag:nextthought.com,2011-10:excused'] = {'auto_grade': {'total_points': 5}}
		part = GradeBookPart()
		book['excused'] = part
		entry = GradeBookEntry()
		...
		cap['tag:nextthought.com,2011-10:unsubmitted'] = {'auto_grade': {'total_points': 5}}
		grade = policy.grade('cald3307')
