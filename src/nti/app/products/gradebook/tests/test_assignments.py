...
class TestAssignments(ApplicationLayerTest):
    ...
    def test_instructor_access_to_history_items_edit_grade(self):
        ...
        csv_text = u'Username,First Name,Last Name,Full Name,Email,Main Title Points Grade,Trivial Test Points Grade,Main Title Points Grade,Adjusted Final Grade Numerator,Adjusted Final Grade Denominator,End-of-Line Indicator\r\nsjohnson@nextthought.com,Steve,Johnson\u0107,Steve Johnson\u0107,,90,,,75,100,#\r\n'
        ...
        csv_text = 'Username,First Name,Last Name,Full Name,Email,Main Title Points Grade,Trivial Test Points Grade,Main Title Points Grade,Adjusted Final Grade Numerator,Adjusted Final Grade Denominator,End-of-Line Indicator\r\n'
        assert_that(res.text, is_(csv_text))
    ...
    def test_download_sorting(self):
        ...
        csv_link = self.require_link_href_with_rel(gradebook_json,
                                                  'ExportContents')
        res = self.testapp.get(csv_link, extra_environ=instructor_environ)
        csv_text = 'Username,First Name,Last Name,Full Name,Email,Main Title Points Grade,Trivial Test Points Grade,Main Title Points Grade,Adjusted Final Grade Numerator,Adjusted Final Grade Denominator,End-of-Line Indicator\r\nsjohnson@nextthought.com,Steve,Johnson,Steve Johnson,,,,,0,100,#\r\naaa@nextthought.com,Jason,Madden,Jason Madden,,,,,0,100,#\r\n'
        assert_that(res.text, is_(csv_text))
        ...
        res = self.testapp.get(csv_link, extra_environ=instructor_environ)
        csv_text = 'Username,First Name,Last Name,Full Name,Email,Main Title Points Grade,Trivial Test Points Grade,Main Title Points Grade,Adjusted Final Grade Numerator,Adjusted Final Grade Denominator,End-of-Line Indicator\r\naaa@nextthought.com,Steve,Johnson,Steve Johnson,,,,,0,100,#\r\nsjohnson@nextthought.com,Jason,Madden,Jason Madden,,,,,0,100,#\r\n'
        assert_that(res.text, is_(csv_text))
        ...
        with mock_dataserver.mock_db_trans(self.ds):
            ...
            lifecycleevent.modified(prof)
        res = self.testapp.get(csv_link, extra_environ=instructor_environ)
        csv_text = u'Username,First Name,Last Name,Full Name,Email,Main Title Points Grade,Trivial Test Points Grade,Main Title Points Grade,Adjusted Final Grade Numerator,Adjusted Final Grade Denominator,End-of-Line Indicator\r\naaa@nextthought.com,Jason,Madden,Jason Madden,,,,,0,100,#\r\nsjohnson@nextthought.com,Steve,Madden,Steve Madden,,,,,0,100,#\r\n'
        assert_that(res.text, is_(csv_text))
        ...
        with mock_dataserver.mock_db_trans(self.ds):
            ...
            lifecycleevent.modified(prof)
        res = self.testapp.get(csv_link, extra_environ=instructor_environ)
        csv_text = 'Username,First Name,Last Name,Full Name,Email,Main Title Points Grade,Trivial Test Points Grade,Main Title Points Grade,Adjusted Final Grade Numerator,Adjusted Final Grade Denominator,End-of-Line Indicator\r\nsjohnson@nextthought.com,Jason,Madden,Jason Madden,,,,,0,100,#\r\naaa@nextthought.com,Steve,Madden,Steve Madden,,,,,0,100,#\r\n'
        assert_that(res.text, is_(csv_text))
