...
class TestGradeScheme(unittest.TestCase):
    ...
    def test_letter_numeric_grade(self):
        ...
        assert_that(lngs.fromCorrectness(1.0), is_('A 100'))
        assert_that(lngs.fromCorrectness(0.99), is_('A 99'))
        assert_that(lngs.fromCorrectness(0.85), is_('B 85'))
        assert_that(lngs.fromCorrectness(0.73), is_('C 73'))
        assert_that(lngs.fromCorrectness(0.65), is_('D 65'))
        assert_that(lngs.fromCorrectness(0.3), is_('F 30'))
